...
- **Framework & Linguagem**: [React 18](https://react.dev/) + [Vite](https://vitejs.dev/) + [TypeScript](https://www.typescriptlang.org/)
- **Estilização & Componentes UI**: [Tailwind CSS](https://tailwindcss.com/) + [shadcn/ui](https://ui.shadcn.com/) (Componentes acessíveis e modulares baseados no Radix UI)
- **Roteamento**: [React Router v6](https://reactrouter.com/)
- **Gerenciamento de Estado & Data Fetching**: [React Query (@tanstack/react-query)](https://tanstack.com/query/latest)
- **Formulários & Validação**: [React Hook Form](https://react-hook-form.com/) + [Zod](https://zod.dev/)
- **Animações e Micro-interações**: [Framer Motion](https://www.framer.com/motion/)
